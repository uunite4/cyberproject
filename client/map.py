...
stoneb = pygame.image.load(s.stone).convert_alpha()
lavab = pygame.image.load(s.lava).convert_alpha()
treeb = pygame.image.load(s.tree).convert_alpha()
peselb = pygame.image.load(s.pesel).convert_alpha()
marbleb = pygame.image.load(s.marble).convert_alpha()
bitmikdashb = pygame.image.load(s.bitmikdash).convert_alpha()
ostoneb = pygame.image.load(s.ostone).convert_alpha()
logb = pygame.image.load(s.log).convert_alpha()
tree_1b = pygame.image.load(s.tree_1).convert_alpha()
tree_2b = pygame.image.load(s.tree_2).convert_alpha()
    ...
    for row_index, row in enumerate(MAP):
        for col_index, tile in enumerate(row):
            ...
            if tile == 'x':
                ...
                surf.blit(s.stone, (x, y))
            elif tile == ' ':

                surf.blit(s.grass, (x, y))
...
def draw_map(screen, map_data, cam_x, cam_y, window_w, window_h, tile_size=s.TILE_SIZE):
