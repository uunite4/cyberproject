...
class PlayerData:
    ...
    def draw(self, surface):
        rect_x = self.x - S.PLAYER_SIZE // 2
        rect_y = self.y - S.PLAYER_SIZE // 2

        pygame.draw.rect(surface, S.BLACK, (rect_x, rect_y, S.PLAYER_SIZE, S.PLAYER_SIZE))
...
def new_place():
    while True:
        ...
        px =random.randint(1,S.WIDTH)
        py = random.randint(1,S.HEIGHT)
